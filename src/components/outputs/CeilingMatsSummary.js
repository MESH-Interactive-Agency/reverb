...
export default class CeilingMatsSummary extends Component {
  ...
  componentDidUpdate() {
    if (this.prevTotal.nrc !== this.total.nrc) {
      this.context.updateCeilingMatTotal(this.total);
    }
            ...
            <table width="480px">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th className="right bold">
                    {this.updateTotal1000(mats[selected].hz1000 * area)}
                  </th>
                  <th className="right bold">
                    {this.updateTotal2000(mats[selected].hz2000 * area)}
                  </th>
                  <th className="right bold">
                    {this.updateTotal4000(mats[selected].hz4000 * area)}
                  </th>
                  <th className="right bold">
